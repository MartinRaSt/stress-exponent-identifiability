...
#
# Runs E2 (SGD convergence, scaling with n, approximation error of the sparse
# model, src/experiments/exp2_solver_scaling.py). Parameter: quick|full|smoke
# (default full). Resumable, three independently checkpointed CSV outputs.
...
"$PYTHON" -m src.experiments.exp2_solver_scaling --"$MODE"
