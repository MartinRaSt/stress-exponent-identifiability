...
#
# K13 (supplement S4): runs exp7 (rank-weighted vs. distance stress,
# src/experiments/exp7_rank_weights.py) -> results/data/[<mode>/]
# exp7_rank_weights_results.csv + results/tables/exp7_rank_weights_summary.csv/.tex.
# Parameter: quick|full|smoke (default full). Short run (8 datasets, n_max=1000).
...
"$PYTHON" -m src.experiments.exp7_rank_weights --"$MODE"
