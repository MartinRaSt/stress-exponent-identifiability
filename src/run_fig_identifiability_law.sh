...
#
# fig_identifiability_law: Veta 3 local quadratic law - Delta_alpha vs.
# alpha^2*I0_exact (log-log, reference slope-1 line) -> results/figures/
# [<mode>/]fig_identifiability_law.pdf/.csv. Requires
# run_exp10_identifiability_check.sh to have already completed in the same
# mode. Parameter: quick|full|smoke.
...
"$PYTHON" -m src.figures.fig_identifiability_law --"$MODE"
