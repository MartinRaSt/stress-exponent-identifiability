...
#
# Runs the exp0 smoke test (see src/experiments/exp0_smoke.py). Resumable -
# a repeated run skips already completed dataset/method/seed combinations.
...
"$PYTHON" -m src.experiments.exp0_smoke
