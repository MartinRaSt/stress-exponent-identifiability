...
#
# Downloads/loads all registered datasets and writes an overview table
# to results/tables/[<mode>/]datasets.csv and datasets.tex. Parameter: quick|full|smoke.
...
"$PYTHON" -m src.datasets.list_datasets --"$MODE"
