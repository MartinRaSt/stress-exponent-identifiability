...
#
# fig_prop2_alpha_prediction: does distance concentration (alpha_bound,
# Proposition 2) predict the empirical optimum of alpha (alpha_star, exp6_alpha_optimum.csv)?
# -> results/figures/[<mode>/]fig_prop2_alpha_prediction.pdf/.csv +
# _spearman.csv. Requires exp8_prop2_check AND exp6_alpha_curves
# (table exp6_alpha_optimum.csv) to have already completed in the same mode. Parameter: quick|full|smoke.
