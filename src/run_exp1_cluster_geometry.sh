...
#
# K2: inter-cluster geometry over the ALREADY SAVED exp1_dr_benchmark embeddings
# (src/experiments/exp1_cluster_geometry.py) - NO re-run of DR methods.
...
"$PYTHON" -m src.experiments.exp1_cluster_geometry --"$MODE"
