...
#
# Runs E1 (dimensionality-reduction/layout method benchmark, src/experiments/exp1_dr_benchmark.py).
# Parameter: quick|full|smoke (default full). Resumable - a repeated
# run skips already completed dataset/method/seed combinations. Logs to
# results/logs/ (see src/common/logging_utils.py), writes
# results/data/exp1_dr_benchmark_DONE.txt on completion.
...
"$PYTHON" -m src.experiments.exp1_dr_benchmark --"$MODE"
