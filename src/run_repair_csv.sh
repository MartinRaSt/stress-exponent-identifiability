...
#
# K14: detection/repair of rows damaged by an interrupted write (hard reset during
# append_result) in results/data/<experiment>_results.csv - see
# src/experiments/repair_csv.py. Example:
#   src/run_repair_csv.sh --csv results/data/exp7_rank_weights_results.csv
#   src/run_repair_csv.sh --csv results/data/exp7_rank_weights_results.csv --repair
...
"$PYTHON" -m src.experiments.repair_csv "$@"
