...
#
# Runs src/experiments/stats.py standalone (Friedman/Nemenyi for the E1/E3/E5
# primary metrics) - output results/data/[<mode>/]stats_<exp>_<metric>.csv.
...
"$PYTHON" -m src.experiments.stats --"$MODE"
