...
#
# Q1-step3 - statistics (families F_B1/F_B2/F_B3, B.5) over the already finished
# exp9_metric_fidelity_results.csv -> results/tables/[<mode>/]
# exp9_metric_fidelity_stats.csv + .tex. Fast run (a few seconds).
...
"$PYTHON" -m src.experiments.exp9_metric_fidelity_stats --"$MODE"
