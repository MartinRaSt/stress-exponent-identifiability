...
REM
REM Runs E5 (ablation study alpha x init x eps_D quantile,
REM src/experiments/exp5_ablation.py). Parameter: quick|full|smoke (default full).
setlocal
cd /d "%~dp0.."
...
"venv\python.exe" -m src.experiments.exp5_ablation --%MODE%
