...
REM
REM Runs E1 (dimensionality-reduction/layout method benchmark, src/experiments/exp1_dr_benchmark.py).
REM Parameter: quick|full|smoke (default full). Resumable - a repeated
REM run skips already completed dataset/method/seed combinations. Logs to
REM results/logs/ (see src/common/logging_utils.py), writes
REM results/data/exp1_dr_benchmark_DONE.txt on completion.
setlocal
cd /d "%~dp0.."
...
"venv\python.exe" -m src.experiments.exp1_dr_benchmark --%MODE%
