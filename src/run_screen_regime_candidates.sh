...
#
# Q1 step 2, step 0: screening of candidate regime L hold-out datasets
# (src/experiments/screen_regime_candidates.py) ->
# results/data/[<mode>/]regime_candidates_screen.csv. Parameter:
# quick|full|smoke (default full). Resumable (1 row = 1 candidate).
...
"$PYTHON" -m src.experiments.screen_regime_candidates --"$MODE"
