...
#
# E15: downstream discovery task over the ALREADY SAVED exp1_dr_benchmark
# embeddings (src/experiments/exp15_discovery_task.py) - NO re-run of DR methods.
# Parameter: quick|full|smoke (default full). Requires exp1_dr_benchmark
# to have already run in the same mode.
...
"$PYTHON" -m src.experiments.exp15_discovery_task --"$MODE"
