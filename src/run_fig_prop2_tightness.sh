...
#
# fig_prop2_tightness: tightness of the Proposition 2 bounds (tight_a/tight_b) vs.
# alpha, color=rho_NN -> results/figures/[<mode>/]fig_prop2_tightness.pdf/.csv.
# Fast aggregation over already finished exp8_prop2_check data, no new computation.
