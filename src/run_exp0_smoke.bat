...
REM
REM Runs the exp0 smoke test (see src/experiments/exp0_smoke.py). Resumable -
REM a repeated run skips already completed dataset/method/seed combinations.
setlocal
cd /d "%~dp0.."
...
"venv\python.exe" -m src.experiments.exp0_smoke
