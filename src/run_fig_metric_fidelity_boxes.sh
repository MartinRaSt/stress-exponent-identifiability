...
#
# fig_metric_fidelity_boxes: boxplots of the primary metric (S1/S2/S3) across
# replicates, method x scenario, with an oracle_truth line -> results/figures/
# [<mode>/]fig_metric_fidelity_boxes.pdf/.csv. Requires
# run_exp9_metric_fidelity.sh to have already completed in the same mode. Parameter: quick|full|smoke.
