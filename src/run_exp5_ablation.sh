...
#
# Runs E5 (ablation study alpha x init x eps_D quantile,
# src/experiments/exp5_ablation.py). Parameter: quick|full|smoke (default full).
...
"$PYTHON" -m src.experiments.exp5_ablation --"$MODE"
