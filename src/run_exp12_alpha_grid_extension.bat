...
REM
REM Runs exp12 (extension of the exp6_alpha_curves alpha grid beyond alpha=3,
REM documentation/2026-09-17_zadani_exp12_prodlouzeni_mrizky.md,
REM src/experiments/exp12_alpha_grid_extension.py) ->
REM results/data/[<mode>/]exp12_alpha_grid_extension_results.csv + _DONE.txt.
REM Requires a COMPLETED exp6_alpha_curves FULL run (fit hyperparameters and
REM the combined-optimum summary are always read from it, regardless of the
REM mode given here - see the module docstring; fail-loud on missing input).
...
"venv\python.exe" -m src.experiments.exp12_alpha_grid_extension --%MODE%
