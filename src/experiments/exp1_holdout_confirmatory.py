...
def _write_booktabs_tex(df: pd.DataFrame, out_path: Path, caption: str, label: str) -> None:
    cols = ["family", "hypothesis_id", "role", "subset", "metric", "method_a", "method_b", "n", "median_diff", "p_perm", "p_holm", "reject_holm"]
    cols = [c for c in cols if c in df.columns]
    lines = [
        "% auto-generated by src/experiments/exp1_holdout_confirmatory.py - do not edit by hand",
