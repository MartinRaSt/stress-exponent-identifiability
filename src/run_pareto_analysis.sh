...
#
# K3: Pareto analysis over exp1_dr_benchmark_results.csv (without a re-run of DR
# methods - fast aggregation, on the order of seconds) -> results/data/pareto_membership.csv,
# results/tables/pareto_summary.csv/.tex, results/tables/pareto_median_front.csv.
# Followed by fig_pareto_front (see src/make_figures.sh).
...
"$PYTHON" -m src.experiments.pareto_analysis --"$MODE"
