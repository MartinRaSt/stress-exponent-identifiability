...
#
# fig_alpha_gain_by_regime: median curve of auc_rnx(alpha)/auc_rnx(0) by
# distance-concentration regime (K6 exp6_alpha_curves x alpha_pred_rule.json)
# -> results/figures/[<mode>/]fig_alpha_gain_by_regime.pdf/.csv. Fast
# aggregation over already finished data (on the order of seconds), no re-run of E6.
