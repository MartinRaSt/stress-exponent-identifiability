...
#
# K6: runs exp6 (alpha curves on a fine grid over all 32 E1 datasets,
# src/experiments/exp6_alpha_curves.py) -> results/data/[<mode>/]
# exp6_alpha_curves_results.csv + results/tables/exp6_alpha_optimum.csv/.tex
# + results/tables/exp6_factorial_summary.csv/.tex. Parameter: quick|full|smoke
# (default full).
...
"$PYTHON" -m src.experiments.exp6_alpha_curves --"$MODE"
